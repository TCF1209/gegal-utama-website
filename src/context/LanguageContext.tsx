...
const translations: Record<Language, TranslationSet> = {
  bm: {
    ...
    faq: {
      ...
      q6: "Adakah saya layak jika saya blacklist?",
      a6: "Maaf, kami tidak dapat meluluskan permohonan jika anda berada dalam senarai hitam CTOS atau CCRIS.",
    },
    contact: {
  ...
  en: {
    ...
    faq: {
      ...
      q6: "Am I eligible if I'm blacklisted?",
      a6: "Sorry, we cannot approve applications if you are blacklisted in CTOS or CCRIS.",
    },
    contact: {
      heading: "Contact Us",
