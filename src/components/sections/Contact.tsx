        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-bold text-gray-900">{t("contact.facebook")}</h3>
                <a
                  href={COMPANY.facebook}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 mt-2 px-4 py-2 rounded-full text-white text-sm font-semibold transition-transform hover:scale-105"
                  style={{ backgroundColor: "#1877F2" }}
                >
                  <ExternalLink className="w-4 h-4" />
                  {t("contact.facebookBtn")}
                </a>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-bold text-gray-900">{t("contact.instagram")}</h3>
                <a
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-bold text-gray-900">{t("contact.tiktok")}</h3>
                <a
                  href={COMPANY.tiktok}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 mt-2 px-4 py-2 rounded-full bg-black text-white text-sm font-semibold transition-transform hover:scale-105"
                >
                  <ExternalLink className="w-4 h-4" />
                  {t("contact.tiktokBtn")}
                </a>
